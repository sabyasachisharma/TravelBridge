...
async function seedTrips() {
  ...
  try {
    ...
    // Delete old seed trips (optional - keeps data fresh)
    ...
    console.log(`📍 Routes include: India-Germany, UK-France, Japan-Korea, and more!`)
    console.log(`📅 All trips have departure dates between ${getFutureDate(2)} and ${getFutureDate(15)}`)
  } catch (error) {
